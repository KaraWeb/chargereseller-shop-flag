jQuery(document).ready(function ($) {
	...
	var Kinds = ["TopUp", "PIN", "WiMax", "Bill", "GiftCard", "Antivirus"];
	var KindTitle = ["شارژ مستقیم", "کارت شارژ", "شارژ وایمکس ایرانسل", "پرداخت قبض", "گیفت کارت", "آنتی ویروس"];
	var KindDescription = 
	[
		...
		, 'پرداخت کلیه قبوض خدماتی از جمله آب، برق، گاز، تلفن ثابت، تلفن همراه ، عوارض شهرداری و جرایم راهنمایی و رانندگی'
	...
	$('input#magiccharge').change(function() {
		if (
		$('input#dataType').val() == 'MTN' || $('input#dataType').val() == 'MTN!' || $('input#dataType').val() == 'MTN#') {
			if ($(this).is(':checke41d')) {
