...
<body>
	<div class="bgs">
		...
		<div class="container verify" style="display:block!important;">
			...
			?>
						<div id="left">
							<img src="<?php echo $root; ?>/img/bill-success.png" class="success" alt="پرداخت موفق">
			...
			?>
						<div id="left">
							<img src="<?php echo $root; ?>/img/topup-success.png" class="success" alt="انجام موفق شارژ مستقیم">
				...
				?>
						<div id="left">
							<img src="<?php echo $root; ?>/img/<?php echo strtolower(substr($result['PinProductKind'], 0, 2)) . '-success.png'; ?>" class="success" alt="عملیات موفق خرید">
