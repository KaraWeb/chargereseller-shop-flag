...
<body>	
                    ...
                    <form accept-charset="utf-8" method="post" id="chargeform" action="http://www.chr724.ir/services/EasyCharge/">
                        <fieldset>
                            ...
                            <div class="payment-gateways">
                                ...
                                <ul>
                                    <li id="Default" class="bank-Default active" data-tooltip="درگاه اصلی"></li>
                            ...
                            <input type="hidden" id="dataRedirectToPage" name="data[scriptVersion]" value="Script-Flag-5.6">
	...
	<script type="text/javascript" src="mobile/js/charge.js?v=1.4"></script>
